...
<title>Daftar</title>
<link rel="shortcut icon" type="x-image/icon" href="images/UTLogo.jpg" />
<link rel="stylesheet" type="text/css" href="css/register.css" />
<link rel="stylesheet" type="text/css" href="css/navigation.css" />
</head>

<body>
<img class="logo" src="images/UTLogo.jpg" width="40px" height="40px"/>
<div id="menu">
	<div id="text-menu">
    </div>
</div>
<div id="table-register">
    ...
    <table id="register">
        ...
        <tr>
            ...
            <td><input type="text" name="nama" style="text-transform: capitalize;" placeholder="Masukan Nama Lengkap" required onkeypress="return harusHuruf(event)"/></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td><input type="email" name="email" placeholder="contoh@email.com" required="required"/></td>
        </tr>
        <tr>
...
<div id="footer">
<i>Capstain Project Kelompok 1B</i>  |  Copyright © 2024.
</div>
